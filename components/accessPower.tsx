...
function accessPower() {
  return (
    <div className="max-w-[1280px] flex flex-col md:flex-row gap-[20px] md:gap-[247px] mt-[192px]  mx-2  md:pl-[64px] bg-[#F9FAFB] min-h-[484px]">
      <div className="mt-[104px] max-w-[648px] min-h-[160px]">
        <h1 className=" font-[500] text-[20px]  md:text-[36px] max-w-[465px] text-[#0A0700]">
          Access the power of our platform on the go.{" "}
        </h1>
        <p className=" font-[400] text-[14px]  md:text-[16px] mt-[24px] max-w-[389px] text-[#475467]">
